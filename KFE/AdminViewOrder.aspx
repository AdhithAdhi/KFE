<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminViewOrder.aspx.cs" Inherits="KFE.AdminViewOrder" %>
        ...
        <form id="cart" runat="server">
            ...
            <div class="card card-outline card-green">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-2">
                        <i class="fas fa-phone-alt"><small> Contact Number : </small> 
                        </i>
                        <br/>
